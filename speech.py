...
start = time.time()
directory = '/data/Downloads/TextSummarizer_OUTPUT/Transcripts'
print("Number of transcripts to summarize : 5")
for filename in os.listdir(directory):
     parent_dir = "/data/Downloads/TextSummarizer_OUTPUT/Summaries"
     number_files = len(os.listdir(parent_dir))
     direct = "Meeting-" + str(number_files)
     ...
     if os.path.isfile(f):
         print("Summarising Transcript-", str(number_files),"...")
         getText(f)

print("Done...")
end = time.time()
print("Time taken to generate summary = ", round((end-start),4)/5," seconds")
